...
* Guest editor: Applied Soft Computing (JCR SCI Q1): Special Issue on Evolutionary Deep Learning for Computer Vision and Image Processing, 2022-2023
* Guest Editor: special issue on Evolutionary and Memetic Algorithms for Computer Vision and Image Processing in the journal of Memetic Computing, 2021-2022 [[Call for Papers](https://cis.ieee.org/images/files/Documents/call-for-papers/tevc/cfp-ecv-special-issue-2022-extended-deadline.pdf)]
* Guest Editor: special issue on Artificial Intelligence for Fault Detection and Diagnosis in the journal of Algorithms, 2021-2022[[ Call for Papers](https://www.mdpi.com/journal/algorithms/special_issues/AI_FD)]

## Organised Special Sessions/Workshops/Symposiums

* Co-organizer: Special Session on Evolutionary Computer Vision and Image Processing(ECVIP) at 2024 IEEE Congress on Computational Intelligence (IEEE WCCI 2024)
* Lead organiser: Workshop on Evolutionary Data Mining and Machine Learning (EDMML) at 2024 IEEE International Conference on Data Mining (IEEE ICDM 2024)
* Co-organizer: Special Session on Evolutionary Computer Vision and Image Processing(ECVIP) at 2024 IEEE Congress on Computational Intelligence (IEEE WCCI 2024)
* Co-organizer: Special Session and Competition on Constrained Multiobjective Optimization at 2024 IEEE Congress on Computational Intelligence (IEEE WCCI 2024)
* Co-organizer: Workshop on Multimodal Optimization for Machine Learning at 2024 IEEE Congress on Computational Intelligence (IEEE WCCI 2024)
* Lead organiser: Workshop on Evolutionary Computation for Explainable Artificial Intelligence (ECXAI) at 2023 IEEE Congress on Evolutionary Computation (IEEE CEC 2023)
* Co-organiser: IEEE Symposium on Computational Intelligence for Multimedia Signal and Vision Processing (IEEE CIMSIVP) at 2023 IEEE Symposium Series On Computational Intelligence (IEEE SSCI 2023)
* Co-organiser: IEEE Symposium on Computational Intelligence for Multimedia Signal and Vision Processing (IEEE CIMSIVP) at 2022 IEEE Symposium Series On Computational Intelligence (IEEE SSCI 2022)
* Co-organiser: Special Session on Evolutionary Computer Vision and Image Processing(ECVIP) at 2023 IEEE Congress on Evolutionary Computation (CEC 2023)
* Co-organiser: Special Session on Evolutionary Computer Vision and Image Processing (ECVIP) at 2022 IEEE World Congress on Computational Intelligence (WCCI 2022)
* Lead organiser: Special Session on Evolutionary Computation for Computer Vision and Image Analysis at 2021 IEEE Symposium Series on Computational Intelligence (IEEE SSCI 2021)
* Lead organiser: Workshop on Evolutionary Data Mining and Machine Learning (EDMML) at 2023 IEEE International Conference on Data Mining (IEEE ICDM 2023)
* Lead organiser: Workshop on Evolutionary Data Mining and Machine Learning (EDMML) at 2022 IEEE International Conference on Data Mining (IEEE ICDM 2022)
* Lead organiser: Workshop on Evolutionary Data Mining and Machine Learning (EDMML) at 2021 IEEE International Conference on Data Mining (IEEE ICDM 2021)
* Lead organiser: Special Session on Computational Intelligence for Computer Vision and Image Processing (CICVIP) at 2021 22nd International Conference on Intelligent Data Engineering and Automated Learning (IDEAL)
...
* The Genetic and Evolutionary Computation Conference (GECCO) Workshop on NeuroEvolution, 2020, 2021, 2022, 2023, 2024
* IEEE Congress on Evolutionary Computation (CEC), 2019，2020, 2021, 2022, 2023, 2024
* IEEE Symposium Series on Computational Intelligence (SSCI), 2017, 2018, 2019, 2020, 2021, 2022, 2023
* International Conference on Image and Vision Computing New Zealand (IVCNZ), 2020, 2021, 2022, 2023
* International Conference on Evolutionary Computation Theory and Applications (ECTA), 2023, 2024
* Pacific-Rim Symposium on Image and Video Technology (PSIVT) 2023
* International Conference on Neural Information Processing (ICONIP), 2023, 2024
* Heterodox Methods for Interpretable and Efficient Artificial Intelligence, 2022
